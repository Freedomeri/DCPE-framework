...
#input_Dir = r'D:\0PythonProjects\PaddleOCR\outputOCR\result_Aoti_x.json'
#output_Dir = r'./user_data/processed_data/data_txt_sorted_myTest.txt'
#input_Dir = r'./raw_data/public_TestB.json'
#output_Dir = r'./user_data/processed_data/data_txt_sorted_Aoti_Aoti.txt'
...
print()
test_dict = {}
file_out_test_B = open(output_Dir, 'w+', encoding='utf-8')
for img_id in tqdm(txts_test["data"]):
    input_seq = []
